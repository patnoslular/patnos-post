...
export const NewsDetail = ({ item, lang, onClose }: NewsDetailProps) => {
  ...
  const getShareUrl = () => {
    ...
    // Kürtçe haberin Kürtçe görünmesi için dil parametresini geri ekliyoruz.
    // Ayrıca Facebook'un hafızasını (cache) zorlamak için küçük bir ek yapıyoruz.
  ...
  const handleFacebookShare = () => {
    ...
    // Facebook Sharer linkini en güncel standartlara göre düzenledim.
